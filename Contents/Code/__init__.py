...
BRAVO_PREFIX 		= "/video/Bravo"

BRAVO_ROOT			= "http://www.bravotv.com/"
BRAVO_SHOWS_LIST	= "http://www.bravotv.com/shows"
...
def Start():
'''    Plugin.AddPrefixHandler(BRAVO_PREFIX, Menu, NAME, ICON, ART)
...
@handler(BRAVO_PREFIX, TITLE, art=ART, thumb=ICON)   
...
def Menu():
	...
	dir.Append(Function(DirectoryItem(ShowList, "Full Episodes"), pageURL = BRAVO_SHOWS_LIST, pageAppend = 
